...
def retrieve_list_of_files(scene_list, update: bool = False):
    """
    Function to buils list of assets from USGS S3
    :param scene_list: Scene list from the bulk file
    :param update: (bool) Flag to force update
    ...
    def build_asset_list(scene):
        ...
        mtl_sr_st_files.update({'update': update})
...
def identifying_data(file_name: str, date_to_process: str, update: bool):
    """
    ...
    :param update: (bool) Bool to force updates
    ...
    try:
        ...
        if scene_list:
            ...
            path_list = retrieve_list_of_files(scene_list=[s for s in scene_list][0:3], update=update)
